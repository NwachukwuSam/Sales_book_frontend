...
//     { id: 'Pos-UBA', name: 'UBA POS', icon: CreditCard, color: 'bg-blue-100 text-blue-600' },
//     { id: 'Pos-Wema', name: 'Wema POS', icon: CreditCard, color: 'bg-purple-100 text-purple-600' },
//     { id: 'Transfer-UBA', name: 'Transfer UBA', icon: CreditCard, color: 'bg-blue-100 text-blue-600' },
//     { id: 'Transfer-Wema', name: 'Transfer Wema', icon: CreditCard, color: 'bg-purple-100 text-purple-600' }
//   ];
...
//   const printReceipt = () => {
//     if (transactionId) {
//       window.open(`${API_BASE_URL}/sales/receipt/${transactionId}`, '_blank');
//     }
//   };
...
//       // Prepare sale data (NO CUSTOMER FIELDS)
//       const saleData = {
//         items: cart.map(item => ({
//           itemId: item._id,
...
//     <div 
//       className="fixed inset-0 z-40 bg-black bg-opacity-20 backdrop-blur-md transition-opacity duration-300"
//       onClick={hideModal}
//     />
